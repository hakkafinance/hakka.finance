...
import StakePosition from './StakePosition/index'
import {
  ChainId,
  HAKKA,
  BURNER_ADDRESS,
    ...
    <div sx={styles.container}>
      <div sx={styles.stakingPageWrapper}>
        ...
        <div sx={styles.body}>
          {/* infoPart */}
          <div>
            <div sx={{ marginTop: '40px', width: '300px' }}>
          ...
          <div sx={styles.stakingCard}>
              ...
              <div sx={styles.optionWrapper}>
                {lockTimeArray.map((month) =>
                  <div
                    ...
                    sx={lockTime === month ? styles.optionItemActive : styles.optionItem}
                    key={month}
                  >
                    {month}
                  </div>
            ...
            <div sx={styles.getsHakkaWrapper}>
              <span sx={{ fontWeight: 'normal' }}>Get sHAKKA (voting power)</span>
              <span>0</span>
            </div>
